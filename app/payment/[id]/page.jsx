  ...
  const sendEmail = async (emailData) => {
    ...
    async function sendScreenshotNotification(planName, username, userEmail, screenshotURL, requestId, amount) {
      ...
      await sendEmail({
            ...
            message: `Hi Admin, amount: ${amount}, user: ${username}, email: ${userEmail}, screenshotURL: ${screenshotURL}, plan: ${planName} . Visit https://www.4xeleventrade.com/admin for more information.
